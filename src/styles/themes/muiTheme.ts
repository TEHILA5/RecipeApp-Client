// ===============================================
// MUI Theme - Sweet&Treat Design System
// ===============================================
...
const theme = createTheme({
  ...
  palette: {
    primary: {
      main: '#e8799a',      // Pink
      light: '#fca5a5',
      dark: '#d4547a',      // Deep Pink
      contrastText: '#ffffff',
    },
    secondary: {
      main: '#c4894a',      // Gold
      light: '#e8c49a',     // Gold Light
      dark: '#a67239',
      contrastText: '#ffffff',
    },
    error: {
    ...
    background: {
      default: '#fdf0f5',   // Soft Pink
      paper: '#ffffff',
    },
    text: {
      primary: '#4a2c3a',   // Text
      secondary: '#9e6b7e', // Mid
    },
  },
  ...
  components: {
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            boxShadow: '0 12px 32px rgba(212, 84, 122, 0.2)',
    ...
    MuiPaper: {
      styleOverrides: {
        root: {
          borderRadius: 16,
          boxShadow: '0 8px 24px rgba(212, 84, 122, 0.1)',
        },
        elevation3: {
          boxShadow: '0 12px 32px rgba(212, 84, 122, 0.15)',
        },
      },
    },
    ...
    MuiAppBar: {
      styleOverrides: {
        root: {
          backgroundColor: 'rgba(255, 248, 242, 0.93)',
          backdropFilter: 'blur(14px)',
          borderBottom: '2px solid rgba(232, 121, 154, 0.18)',
          boxShadow: 'none',
          color: '#4a2c3a',
        },
      },
