...
const faqs = [
  { q: 'Can I submit my own recipes?', a: "Not yet — but we're working on a community submission feature. Stay tuned!" },
...
export default function FAQPage() {
  return (
    <StaticPage emoji="❓" title="FAQ" subtitle="Frequently Asked Questions">
