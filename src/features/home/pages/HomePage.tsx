// ===============================================
// Home Page - עם מתכונים אמיתיים מהשרת
// ===============================================
      ...
      <div className="card-img-wrap">
        {recipe.arrImage ? (
          <img
            ...
            className="card-img"
            onError={(e) => {
              // אם התמונה לא נטענת - מציגים emoji
              (e.target as HTMLImageElement).style.display = 'none';
              (e.target as HTMLImageElement).nextElementSibling!.classList.remove('hidden');
            }}
          />
        ) : null}
        {/* fallback emoji אם אין תמונה */}
        <div
  ...
  return (
    <div className="featured-wrap">
        ...
        {recipe.arrImage ? (
          ...
          <div className="featured-img"
               style={{ background: 'linear-gradient(135deg, #e8799a, #c4894a)',
                        display: 'flex', alignItems: 'center',
                        justifyContent: 'center', fontSize: '150px' }}>
            {emoji}
          </div>
        )}
      </div>
      <div className="featured-body">
        ...
        <Link to={`/recipes/${recipe.id}`} className="btn-pink">
          View Recipe →
        </Link>
      </div>
    </div>
  ...
  return (
    <div className="home-page">
      ...
      <section className="section">
        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: '60px', color: 'var(--mid)' }}>
            Loading featured recipe...
          </div>
        ) : featuredRecipe ? (
          <FeaturedCard recipe={featuredRecipe} />
        ) : (
          // placeholder אם אין מתכונים
          <div className="featured-wrap">
            <div className="featured-img-wrap">
              <div className="featured-img"
                   style={{ background: 'linear-gradient(135deg, #e8799a, #c4894a)',
                            display: 'flex', alignItems: 'center',
                            justifyContent: 'center', fontSize: '150px' }}>🍓</div>
            </div>
            <div className="featured-body">
              <div className="featured-badge">⭐ Featured</div>
